...
public class AgendaDeNume {
    ...
    public static void main(String[] arguments) {
        ...
        do {
            ...
            printConsole("4 - modifica nume");
            printConsole("5 - stergem nume");
            printConsole("7 - exit");
            ...
            if (optiune == 1)
                ...
                if (optiune == 2) {
                    ...
                    if (optiune == 3) {
                        String numec = readStringConsole("numele de cautat: ");
                        printConsole("numele se afla pe pozitia: " + cautare(numec));
                    } else {
                        if (optiune == 4) {
                            String modif = readStringConsole("introdu numele de modif: ");
                            modifDeNume(modif);
                        } else if (optiune == 5) {
                            String modif = readStringConsole("introdu numele de sters: ");
                            modifDeNumeNull(modif);
                        }
                    }
                }
            }
    ...
    public static void modifDeNumeNull(String valoare) {
        int j = cautare(valoare);
        sirDeNume[j] = null;

    }

    public static void modifDeNume(String valoare) {
        int j = cautare(valoare);
        sirDeNume[j] = readStringConsole("cu ce nume sa inlocuiesc: ");
